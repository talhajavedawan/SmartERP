...
namespace ERP_BL.ChatManager
{
    ...
    {
        const string DEPARTMENTAL_GROUP_PATH = "DepartmentalGroups/";
        const string CUSTOM_GROUP_PATH = "CustomGroups/";
        ...
        public ChatManager()
        {
            ...
            //{
            //    AuthSecret = "yMn7lEwLta6DRoDOWaKJmDKoXq7oAOt4AEhQjtsw",
            //    BasePath = "https://zaschat-ef2fc.firebaseio.com/"
            //}; 
            {
                AuthSecret = "b6f7NWzYsDLYGT6QM659MVqowSEgUvNS4MFi08gh",
                BasePath = "https://zaschat-e9f39.firebaseio.com/"
            };
 
            client = new FireSharp.FirebaseClient(config);
            if (client == null)
            {
                throw new Exception("Chat Manager unable to connect.");
            }
            ChatNotifs = new ChatNotifs();
        }
