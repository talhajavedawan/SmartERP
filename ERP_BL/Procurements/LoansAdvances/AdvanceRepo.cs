...
namespace ERP_BL.Procurements.LoansAdvances
{
    public class AdvanceRepo
    {
        ...
        /// <summary>
        /// Get All Loans and Advances for Company and Department
        /// </summary>
        /// <returns></returns>
        public List<LoansAdvance> GetAllLoansAdvancesByCompDept(int compId, int deptId)
        {
            return context.loansAdvances

           .Where(x => x.companyId == compId && x.deptId == deptId && x.isLinkable == true)
           .ToList();
        }
        ...
        public List<LoansAdvance> GetAllLoansAdvances(int uid)
        {
           ...
           .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
           .ToList();
        ...
        public List<LoansAdvance> getCashFlowAllActive(int uid)
        {
           ...
           || x.creatorId == uid && deptIds.Contains(x.department.Id))
           && ((companyIds.Contains(x.company.Id) && deptIds.Contains(x.department.Id) 
           && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill)
           || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill))  && deptIds.Contains(x.department.Id) &&
           x.Status.isActive == true && 
           x.isReApproved != false &&
           x.isApproved == true &&
           x.PendingForClosing != true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
           .ToList();
        ...
        .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && x.isApproved == false && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
         .ToList();
        }
        ...
        public List<LoansAdvance> getAllPendingForClosingDepartmental(int uid)
        {
            ...
            return context.loansAdvances
            .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && x.PendingForClosing == true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
            .ToList();
        }
        ...
        public List<LoansAdvance> getLoansAdvancebyCompanyDept(int compId, List<Department> departments, int currId)
        {
           ...
           .Where(x => x.companyId == compId && x.currencyId == currId && x.Status.isActive == true && x.isApproved == true && x.isVoid != true && dept_Ids.Contains((int)x.deptId) && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
           .ToList();
        ...
        /// </summary>
        /// <returns></returns>
        public List<LoansAdvance> getLoansAdvanceForSR(int compId, List<Department> departments, int currId)
        {
            List<int> dept_Ids = new List<int>();
            foreach (var _dept in departments)
            {
            ...
            return   context.loansAdvances
           .Where(x => x.companyId == compId && x.currencyId == currId && x.Status.isActive == true && x.isApproved == true && x.isVoid != true && dept_Ids.Contains( x.deptId.Value) && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
           .ToList();
        }
        ...
        public int getAllPendingForApprovalCount(int uid)
        {
            ...
            return context.loansAdvances
                ...
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && (x.Creator.employee.SupervisorId == user.employee.EmpId || x.Creator.employee.EmpId == user.employee.EmpId || x.Creator.employee.Supervisor.Supervisor.SupervisorId == user.employee.EmpId || x.Creator.employee.Supervisor.SupervisorId == user.employee.EmpId) && x.isApproved == false && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForApprovalCountOwn(int uid)
        {
            ...
            return context.loansAdvances
                ...
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && (x.Creator.employee.EmpId == user.employee.EmpId) && x.isApproved == false && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        {
            return context.loansAdvances
    .Where(x => x.isVoid == true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
    .Count();
        }
        ...
        public int getBankTransferRegisterCountOWn(int uid)
        {
            ...
            foreach (var comp in user.employee.AdminBillCompanies)
                adminCompanyIds.Add(comp.Id);
            return context.loansAdvances
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && (x.Creator.employee.EmpId == user.employee.EmpId) && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForAdministratorCount()
        {
            return context.loansAdvances
                ...
                .Where(x => x.isApproved == false && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForClosingDepartmentalCount(int uid)
        {
            ...
            return context.loansAdvances
                ...
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && x.isApproved == true && x.PendingForClosing == true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForClosingCount(int uid)
        {
            ...
            return context.loansAdvances
                ...
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && (x.Creator.employee.SupervisorId == user.employee.EmpId || x.Creator.employee.EmpId == user.employee.EmpId || x.Creator.employee.Supervisor.SupervisorId == user.employee.EmpId || x.Creator.employee.Supervisor.Supervisor.SupervisorId == user.employee.EmpId) && x.isApproved == true && x.PendingForClosing == true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForClosingCountOwn(int uid)
        {
            ...
            return context.loansAdvances
                ...
                .Where(x => (deptIds.Contains(x.department.Id) || x.creatorId == uid) && ((companyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Vendor_Bill) || (adminCompanyIds.Contains(x.company.Id) && x.loansAdvanceType == Enums.LoansAdvanceType.Admin_Bill)) && (x.Creator.employee.EmpId == user.employee.EmpId) && x.isApproved == true && x.PendingForClosing == true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
        ...
        public int getAllPendingForClosingAdministratorCount()
        {
            return context.loansAdvances
                ...
                .Where(x => x.isApproved == true && x.PendingForClosing == true && x.isVoid != true && x.advanceTemplate == Enums.LoansAdvanceTemplate.Advance)
                .Count();
        }
