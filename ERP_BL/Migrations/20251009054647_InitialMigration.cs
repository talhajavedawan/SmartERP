        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BusinessTypeName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    IsVoid = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SystemDisplayName = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    ...
                    PayGrade = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    HRManager = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ProbationPeriodEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Employees_Addresses_TemporaryAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Groups_AspNetUsers_LastModifiedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_UserSetting_SingleUserType", "[UserId] IS NULL OR [PowerUserId] IS NULL");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSettings_PowerUsers_PowerUserId",
                        column: x => x.PowerUserId,
                        principalTable: "PowerUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_SystemDisplayName",
                table: "Employees",
                column: "SystemDisplayName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Employees_TemporaryAddressId",
                table: "Employees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSettings_PowerUserId",
                table: "UserSettings",
                column: "PowerUserId");
