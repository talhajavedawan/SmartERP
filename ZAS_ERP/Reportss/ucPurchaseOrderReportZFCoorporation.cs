...
{
    public partial class ucPurchaseOrderReportZFCoorporation : DevExpress.XtraReports.UI.XtraReport
    {
        List<ProcurementProduct> procurementProducts = new List<ProcurementProduct>();
        PurchaseOrder purchaseOrder;
        public ucPurchaseOrderReportZFCoorporation()
        {
            InitializeComponent();
           
        }
        public ucPurchaseOrderReportZFCoorporation(PurchaseOrder PO)
        {
            InitializeComponent();
            purchaseOrder = PO;
