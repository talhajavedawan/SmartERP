...
{
    /// <summary>
    /// Interaction logic for ucSaleOrderReportViewFav.xaml
    /// </summary>
    public partial class ucSaleOrderReportViewFav : UserControl
    {
        ...
        public ucSaleOrderReportViewFav()
        {
        ...
        public ucSaleOrderReportViewFav(GridReport reportToEdit, string title)
        {
        ...
        private void OnRunWorkerCompleted(object o, RunWorkerCompletedEventArgs args)
        {
            ...
            string path = this.lblHeading.Caption.ToString();
