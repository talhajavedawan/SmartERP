...
{
    /// <summary>
    /// Interaction logic for ucPurchaseOrderViewFav.xaml
    /// </summary>
    public partial class ucPurchaseOrderViewFav : UserControl
    {
        ...
        public ucPurchaseOrderViewFav()
        {
            InitializeComponent();
        }
        public ucPurchaseOrderViewFav(GridReport reportToEdit, string title)
        {
            InitializeComponent();
            report = reportToEdit;
            reportTitle = title;
